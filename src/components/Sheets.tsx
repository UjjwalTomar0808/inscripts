...
export default function Component() {
    ...
    return (
        <div className="bg-[#faf4ee] flex justify-center">
            <div className="font-work w-full h-[1024px] bg-white">
                {/* Header */}
                ...
                <div className="bg-white  border-b border-[#e2e2e2]">
                    <div className="flex items-center space-x-2">
                        <div className="flex items-center w-[720px] h-[32px] gap-2 p-2 ml-12 bg-[#E2E2E2] ">
                        ...
                        <div className="flex ml-34">
                            <div
                                className="flex items-center gap-1 bg-[#D2E0D4] text-[#0a6e3d] py-1.5  w-[130px] h-[32px] text-[14px] font-medium cursor-pointer justify-center"
                            ...
                            <div
                                className="flex items-center gap-1 bg-[#DCCFFC] text-[#463E59] px-2 w-[251px] h-[32px] py-1.5 text-sm font-medium cursor-pointer justify-center"
                            ...
                            <div
                                className="flex items-center gap-1 bg-[#FAC2AF] text-[#695149] px-2 w-[130px] py-1.5  text-sm font-medium cursor-pointer h-[32px] justify-center"
                        ...
                        <div className="flex items-center justify-center align-middle xl:px-6 md:px-4 sm:px-2">     
                            <Button
                            variant="ghost"
                            size="sm"
                            className="text-[#757575] h-7 w-7 p-3"
                            ...
                            <tbody>
                                {tasks.map((task, index) => (
                                    <tr key={task.id} className="border-b border-[#e2e8f0] hover:bg-[#f8fafc] h-[32px]">
                                        ...
                                        <td className="px-3 text-left border-r border-[#e2e2e2] truncate">
                                            <EditableCell
                                        ...
                                        <td className="px-3 border-r border-[#e2e2e2] truncate">
                                            <Badge className={`${getStatusColor(task.status)} text-[12px] w-auto h-[24px]  cursor-pointer truncate`}>
                                                {task.status}
                                            </Badge>
                                        </td>
                                        <td className="px-3 text-left border-r border-[#e2e2e2] truncate">
                                        ...
                                        <td className="border-r px-3 text-left border-[#e2e2e2] truncate">
                                            <EditableCell
                                                value={task.assigned}
